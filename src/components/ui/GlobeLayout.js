        ...
        if (globeRef.current && globeData) {
            globeRef.current
                ...
                .hexPolygonColor((polygon) => {
                    if (polygon.properties.ADMIN === "Tunisia") {
                        return "rgba(0, 255, 0, 0.8)"; // Highlight Tunisia in green
                    }
                    return defaultProps.polygonColor; // Default color for other countries
                });
            startAnimation();
        }
    }, [globeData]);
